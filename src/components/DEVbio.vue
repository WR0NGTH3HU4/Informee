...
<template>
  <div
    class="DEVbio flex flex-row justify-between content-center items-center w-4/12 bg-neutral-100 rounded pl-6 pr-6 pb-3 pt-3 border-neutral-300 drop-shadow-lg relative m-5"
  >
    <div class="svg"></div>
...
.svg {
  ...
  top: 0;
  left: 0;
  width: 100%; // Set the appropriate width for your SVG
  height: 100%; // Make it fill the height of the parent container
  background-size: contain; // Ensure the SVG fits within the container
