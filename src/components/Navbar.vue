...
<template>
  ...
  <nav class="flex justify-between items-center px-4">
    ...
    <div class="dropdown w-[250px] h-[180px] bg-neutral-100 rounded border-neutral-300 border-[1px] drop-shadow-lg self-end mx-3"><!--Dropdown-->
      ...
      <div @click.prevent="shareProfileLink"  class="Option transition-colors  cursor-pointer">
...
.Option{
  @apply flex flex-row justify-start content-center items-center p-3 gap-x-3 w-full hover:bg-neutral-200 active:bg-neutral-50 duration-200
} 
.OptionItem{
