...
<template>
  <div v-if="isModalShown" class="ModalPos absolute inset-0 overflow-y-auto bg-black bg-opacity-50 flex flex-col justify-center content-center items-center">
    <div class="FullModal flex flex-col justify-evenly content-center items-center rounded bg-neutral-50 border-neutral-300 drop-shadow-lg w-1/5 min-w-[300px] min-h-[300px] pt-8 pb-2 gap-y-2">
      ...
      <h3 class="ErrorMsg text-center text-2xl font-bold text-neutral-700 w-1/2">{{ currentStatus }}</h3>
      <p class="Explanation text-center text-neutral-500 w-1/2">Hiba történt a bejelentkezés során</p>
      <div class="Close flex flex-col justify-end content-center items-end border-neutral-300 pt-3 px-3 w-full">
